...
class TestMessageBus:
    ...
    def test_handle_login_user_command(self, mock_unit_of_work):
        ...
        command = LoginUserCommand(email="test@example.com", password="testpassword123")
...
class TestLoginUserCommandHandler:
    ...
    def test_handle_login_user_success(self, mock_unit_of_work):
        ...
        with patch(
            "modules.auth.domain.services.user_services.verify_password",
            return_value=True,
        ):
            with patch(
                "modules.auth.domain.services.user_services.generate_jwt_token",
    ...
    def test_handle_login_user_invalid_password(self, mock_unit_of_work):
        ...
        # Arrange
        handler = UserCommandHandler()
        command = LoginUserCommand(email="test@example.com", password="wrongpassword")
    ...
    def test_handle_login_user_suspended(self, mock_unit_of_work):
        ...
        handler = UserCommandHandler()
        command = LoginUserCommand(
            email="suspended@example.com", password="testpassword123"
        )
